        ...
        <div class="agile_top_w3_grids">
			<div class="panel panel-info">
                <div class="panel-heading"> <i class="fa fa-unlock-alt" aria-hidden="true"></i>
                    <a href="<?php print base_url('Grocery_item/add_grocery');?>">
                            ...
                            <tbody>
                            	...
                            	?>
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="<?php print base_url('Grocery_item/edit_product/'.$value->id);?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> |

                                            <a href="<?php print base_url('Grocery_item/delete_grocery/'.$value->id);?>" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
