              ...
              <div class="panel panel-info">
                ...
                <div class="panel-heading" style="text-align: center;font-size: 16px;"> <i class="fa fa-star" aria-hidden="true"></i>
                  ...
                  <div class="panel-body">
                    ...
                    ?>
                    <form action="<?php echo base_url('super_admin/SaveFloverWeight');?>" enctype="multipart/form-data" method="post">
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" name="flaver" class="form-control" >
                        </div>
                      </div>
                      ...
                      <div class="form-actions">
                        <button type="submit" name="submit" class="btn btn-primary">Save IT</button>
                      </div>
                    </form>
                  </div>
                </div>
