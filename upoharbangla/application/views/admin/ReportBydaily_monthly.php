...
<div id="date" style="display: none">
    <form method="post" action="<?php echo base_url('Super_admin/searchByDate');?>" onsubmit="return checkDate()">
        ...
        <div class="btn-group col-md-3 col-sm-3">
            <button style="margin-top: 30px"  id="addRow" onclick="checkDate()" onclick="" class="btn btn-info">Submit
            </button>
        </div>
    </form>
</div>
...
<form action="<?php echo base_url('Super_admin/searchByOrderId');?>" method="post">
    <div id="order" style="display: none;">
        ...
        <div class="btn-group col-md-3 col-sm-3" >
            <button style="margin-top: 30px"  type="submit" class="btn btn-info">
                Submit
            </button>
        </div>
    </div>
...
<div class="btn-group col-md-3 col-sm-3" id="searchbyoder">
    <button style="margin-top: 30px"  id="searchbyorderid" onclick="searchbydorder()" class="btn btn-info">Search By OrderID
    </button>
</div>
...
<script>
    ...
    function checkDate() {
        ...
        if (startdate > enddate){
            ...
            $.ajax({
                type:'POST',
                url:'<?php echo base_url("Super_admin/searchByDate" )?>',
