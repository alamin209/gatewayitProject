                        ...
                        <div class="col-md-8">
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    ?>
                                    <form name="edit_category" id="edit_category" action="<?php echo base_url('Foodcourt/update_food');?>" enctype="multipart/form-data" method="post" onsubmit="return(validate());">
