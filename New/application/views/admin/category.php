                            ...
                            <tbody>
                            	...
                            	?>
                                    <tr>
                                        ...
                                        <td class="center"><a href="<?php print base_url('edit_category/'.$value->cat_id);?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>|

                                       <a href="<?php print base_url('delete_category/'.$value->cat_id);?>" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                    </tr>
                                <?php }?>
                            </tbody>
                        </table>
