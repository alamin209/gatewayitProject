                            	...
                            	?> 
                                    <tr>
                                        ...
                                        <td class="center"><?php print $value->category;?></td>
                                         <td class="center">
                                            <img src="<?php print base_url($value->photo);?>" height="120px" width="100px" title="category image" alt="category image">
                                        </td>
                                        <td class="center"><a href="<?php print base_url('edit_subcategory/'.$value->subcat_id);?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>|
                                        <a href="<?php print base_url('delete_subcategory/'.$value->subcat_id);?>" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                    </tr>
                               <?php }?>
                            </tbody>
                        </table>
