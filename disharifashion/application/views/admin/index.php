...
<html lang="zxx">
<head>
<title>Dishari Fashion | Admin Panel</title>
<!-- custom-theme -->
...
<div class="wthree_agile_admin_info">
	...
	<div class="w3_agileits_top_nav">
		<ul id="gn-menu" class="gn-menu-main">
			<!-- //nav_agile_w3l -->
			<li class="second logo admin"><h1><a href=""><i class="fa fa-graduation-cap" aria-hidden="true"></i>Dishari Fashion</a></h1></li>
...
<div class="copyrights">
	<p>© 2018 Dishari Fashion. Developed by  <a href="http://gatewayit.net/" target="_blank">Gateway IT</a> </p>
</div>	
