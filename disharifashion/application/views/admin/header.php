...
<html lang="zxx">
	<head>
		<title>Dishari Fashion - Master Panel</title>
		<!-- custom-theme -->
		...
		<div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="<?php print base_url('subcategory');?>"> <i class="fa fa-table"></i> Sub-Category</a>
								</li>
				...
				<li class="second logo">
					<h1><a href="<?php print base_url('master');?>"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Dishari Fashion</a></h1>
				</li>
